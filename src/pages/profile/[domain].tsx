...
const MyProfile: NextPage = () => {
  ...
  useEffect(() => {
    ...
    // console.log("Validation", (domainData as { owner: string })?.owner, address);
    else if ((domainData as { owner: string })?.owner === address && address && address !== undefined) {
      // console.log("Validation", (domainData as { owner: string })?.owner, address);
      setIsOwner(true);
  ...
  }, [domainData, address, isConnected, domain]);
      ...
      {domainStatus === "loading" ? (
        ...
        <>
          ...
          <>
            ...
            <TabView domain={domainDetails} user={userDetails} owner={isOwner} />
          </>
          {/* ) : (
            <Container>
